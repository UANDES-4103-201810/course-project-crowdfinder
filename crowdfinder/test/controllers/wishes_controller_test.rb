...
class WishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post wishes_url, params: { wish: { project_id: @wish.project_id, user_id: @wish.user_id } }
    end
  ...
  test "should update wish" do
    patch wish_url(@wish), params: { wish: { project_id: @wish.project_id, user_id: @wish.user_id } }
